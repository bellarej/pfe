...
const EditTask = (props) => {
       const { AllArticles, AllUsers, createNewTask, edit, selectedTask, securitiesStore, updateTask } = props;
       ...
       const { control, handleSubmit } = useForm({
              ...
              defaultValues: {
                     ...
                     interventionPrice: selectedTask?.interventionPrice || '',
                     clientName: selectedTask?.client?.clientName || '',
                     clientAddress: selectedTask?.client?.address || '',
                     clientNum: selectedTask?.client?.num || '',
                     changedBy: selectedTask?.changedBy?.id || '',
                     selectedArticle: [...selectedTask?.selectedArticle] || [],
              },
       ...
       const onSubmit = (data) => {
              ...
              updateTask(selectedTask.id, securitiesStore?.currentUser?.id, data, setModal, setErrorMsg);
                                                 ...
                                                 <Controller
                                                        ...
                                                        render={({ field, onChange, value, name, ref }) => (
                                                               ...
                                                               >
                                                                      ...
                                                                      {AllUsers &&
                                                                             AllUsers.map((item) => <option value={item.id}>{item.email}</option>)}
                                                               </CSelect>
                                                        )}
                                                 />
...
export default connect(StateProps, {})(EditTask);
